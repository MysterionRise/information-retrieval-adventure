...
public class BoostPrefixScoringRewrite extends ScoringRewrite<BooleanQuery.Builder> {
  ...
  protected void addClause(
      BooleanQuery.Builder topLevel, Term term, int docCount, float boost, TermContext states) {
  ...
  protected void checkMaxClauseCount(int count) {
    if (count > BooleanQuery.getMaxClauseCount()) throw new BooleanQuery.TooManyClauses();
  }
}
