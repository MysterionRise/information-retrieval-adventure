...
public class FindTerm {
  ...
  public static void main(String[] args) throws IOException {
    ...
    while (iterator.hasNext()) {
      ...
      while (term != null) {
        System.out.println(
            term.utf8ToString() + " " + NumericUtils.sortableBytesToInt(term.bytes, term.offset));
    ...
    final TopDocs filteredTopDocs =
        new TopDocs(scoreDocs.size(), scoreDocs.toArray(new ScoreDoc[0]), maxScore);
